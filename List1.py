...
def generate_random_list(n = 10, min = 1, max = 100, print = False):
    """
...
try:
    random_list = generate_random_list(int(input("Enter list size:")),int(input('Enter min list value:')),int(input('Enter max list value:')))
